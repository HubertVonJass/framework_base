    ...
    public void updateLogo() {
        ...
        switch(mLogoStyle){
            ...
            case 27:
                ...
                break;
            case 28:
                drawable = mContext.getResources().getDrawable(R.drawable.ic_psybernetiq);
                break;
            case 29:
                drawable = mContext.getResources().getDrawable(R.drawable.ic_pentagram);
                break;
            case 30:
                drawable = mContext.getResources().getDrawable(R.drawable.ic_anarchy);
                break;
            case 31:
                drawable = mContext.getResources().getDrawable(R.drawable.ic_necronomicon);
                break;
             case 32:
                drawable = mContext.getResources().getDrawable(R.drawable.ic_psi);
                break;
       }
